...
function CookiePolicy() {
  return (
    <div className="container">
      <h1 className="mb-5 mt-5" style={{ textAlign: 'center' }}>Cookie Policy for Homecooked Heaven</h1>
      <h2>What Are Cookies?</h2>
      <p>
        As is common practice with almost all professional websites, this site uses cookies, which are tiny files that are downloaded to your computer, to improve your experience. This page describes what information they gather, how we use it, and why we sometimes need to store these cookies. We will also share how you can prevent these cookies from being stored, however, this may downgrade or 'break' certain elements of the site's functionality. <br /><br />For more general information on cookies, see the Wikipedia article on <a href="https://en.wikipedia.org/wiki/HTTP_cookie">HTTP Cookies</a>.
      </p>
      ...
      <p>
        This site uses Google Analytics, which is one of the most widespread and trusted analytics solutions on the web for helping us to understand how you use the site and ways that we can improve your experience. These cookies may track things such as how long you spend on the site and the pages that you visit so we can continue to produce engaging content. <br /><br />For more information on Google Analytics cookies, see the official <a href="https://marketingplatform.google.com/info?authuser=0">Google Analytics page</a>.
      </p>
      <h3>More Information</h3>
      <p>
        Hopefully, that has clarified things for you, and as was previously mentioned, if there is something that you aren't sure whether you need or not, it's usually safer to leave cookies enabled in case it does interact with one of the features you use on our site. <br /><br /> However, if you are still looking for more information, then you can contact us through one of our preferred contact methods: <br />Email: contact@homecookedheaven.com <br />Phone: +1 (123) 456-7890
      </p>
    </div>
  );
}
